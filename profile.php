        ...
        <body>
            ...
            <div style="text-align: center">
                ...
                <div class="user-details">
                    <p>User: <span class="blog-author-name"><?= $user['user_full_name'] ?></span></p>
                    <?php if (!$isCurrentUser) : ?>
                        <form method="POST" action="followuser.php">
                            <input type="hidden" name="user_id" value="<?= $user_id ?>">
                            <button type="submit"><?= $totalFollowers ?> <?= $followButtonText ?></button>
                        </form>
                    <?php else : ?>
                        <button class="follow-button" disabled><?= $totalFollowers ?> follower</button>
                    <?php endif; ?>
                </div>
            </div>
            <div style="text-align: center">
