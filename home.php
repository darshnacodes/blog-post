		...
		<div class="blog-wrapper">
			...
			?>
					<section class="blogpost">
						<div class="blogtitle"><?= $post_title ?> <p class="blogauthor">By <a class="blog-author-name" href="profile.php?id=<?= $blogpost['user_id'] ?>"><?= $author ?></a></p>
						</div>
						<div style="color: #dff1f1;"><?= $post_body ?>. <a style="color: white; text-decoration: underline;" href="post.php?id=<?= $post_id ?>">read more...</a></div>
